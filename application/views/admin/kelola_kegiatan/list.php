                        ...
                        <div class="box-body">
                            ...
                            <table id="table-regular" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td> 
                                    <a href="<?php echo site_url('admin/kelola_kegiatan/edit/' . $res->id_kegiatan);?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> edit</a>
                                    <a href="<?php echo site_url('admin/kelola_kegiatan/delete/' . $res->id_kegiatan);?>" class="btn btn-danger btn_hapus btn-xs"><i class="fa fa-trash"></i> hapus</a>
                                    </td>
                                </tr>
                            <?php } ?>
                                </tbody>
