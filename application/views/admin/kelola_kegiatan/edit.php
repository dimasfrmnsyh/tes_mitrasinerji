    ...
    <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-red">
                        ...
                        <form class="" action="<?php echo site_url('admin/kelola_kegiatan/edit/' . $id_kegiatan);?>" method="post">
                               <div class="box-body">
                          <div class="row">
                            <div class="col-md-5">
                              ...
                              <div class="form-group <?php echo (form_error('tanggal')) ? 'has-error' : '';?>">
                                ...
                                <input class="form-control" type="date" name="tanggal" value="<?php echo $kegiatan->tanggal; ?>">
                              ...
                              <div class="form-group <?php echo (form_error('jam_mulai')) ? 'has-error' : '';?>">
                                ...
                                <input class="form-control" type="text" placeholder="HH:MM:SS" id="time" name="jam_mulai"  value="<?php echo $kegiatan->jam_mulai; ?>">
                              ...
                              <div class="form-group <?php echo (form_error('jam_selesai')) ? 'has-error' : '';?>">
                                ...
                                <input class="form-control" type="text" placeholder="HH:MM:SS" id="time" name="jam_selesai"  value="<?php echo $kegiatan->jam_selesai; ?>">
                              ...
                              <div class="form-group <?php echo (form_error('uraian_kegiatan')) ? 'has-error' : '';?>">
                                ...
                                <input class="form-control" type="text" name="uraian_kegiatan"  value="<?php echo $kegiatan->uraian_kegiatan; ?>">
                            ...
                            <div class="col-md-5">  
                               <div class="form-group <?php echo (form_error('tempat_kegiatan')) ? 'has-error' : '';?>">
                                 ...
                                 <input class="form-control" name="tempat_kegiatan" value="<?php echo $kegiatan->tempat_kegiatan; ?>"></input>
                             ...
                             <div class="col-md-5">  
                               <div class="form-group <?php echo (form_error('alamat')) ? 'has-error' : '';?>">
                                 ...
                                 <input class="form-control" name="alamat" value="<?php echo $kegiatan->alamat; ?>"></input>
                          ...
                          <div class="col-md-5">  
                               <div class="form-group <?php echo (form_error('keterangan')) ? 'has-error' : '';?>">
                                 ...
                                 <input class="form-control" name="keterangan"value="<?php echo $kegiatan->keterangan; ?>"></input>
        ...
        <a href="<?php  echo base_url('admin/kelola_kegiatan') ?>" class="btn btn-xs btn-default" href=""><i class="fa fa-long-arrow-left"></i> Kembali Ke list produk</a>
